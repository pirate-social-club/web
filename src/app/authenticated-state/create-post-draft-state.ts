...
export type CreatePostDraftState = {
  ...
  deckState: LearningDeckComposerState;
...
type DraftAction =
  ...
  | { type: "setDeckState"; value: React.SetStateAction<LearningDeckComposerState> }
  ...
  | { type: "setRoyaltySplit"; value: React.SetStateAction<AssetRoyaltySplitState> }
  ...
  | { type: "setVideoState"; value: React.SetStateAction<VideoComposerState> };
...
type CreatePostDraftActions = {
  ...
  setDeckState: React.Dispatch<React.SetStateAction<LearningDeckComposerState>>;
  ...
  setRoyaltySplit: React.Dispatch<React.SetStateAction<AssetRoyaltySplitState>>;
  ...
  setVideoState: React.Dispatch<React.SetStateAction<VideoComposerState>>;
};
...
function createInitialDraftState(): CreatePostDraftState {
  return {
    ...
    deckState: defaultLearningDeckState(),
    identityMode: "public",
    imageUpload: null,
    ...
    royaltySplit: defaultAssetRoyaltySplitState(),
...
function createPostDraftReducer(state: CreatePostDraftState, action: DraftAction): CreatePostDraftState {
  switch (action.type) {
    ...
    case "setDeckState":
      return { ...state, deckState: resolveSetState(state.deckState, action.value) };
    ...
    case "setVideoState":
      return { ...state, videoState: resolveSetState(state.videoState, action.value) };
  }
}
...
export function useCreatePostDraftState(initial?: Partial<CreatePostDraftState>): {
  ...
  const actions = React.useMemo<CreatePostDraftActions>(() => ({
    ...
    setDeckState: (value) => dispatch({ type: "setDeckState", value }),
    ...
    setVideoState: (value) => dispatch({ type: "setVideoState", value }),
  }), []);
