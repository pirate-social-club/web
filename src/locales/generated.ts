  ...
  "en": {
    "routes": {
      "common": {
        ...
        "later": "Later.",
        "selfVerificationQrCode": "Self verification QR code",
        "qrRenderError": "Could not render the verification QR code.",
      ...
      "home": {
        ...
        "emptyHomeBody": "Follow or join a community to start building your home feed.",
  ...
  "ar": {
    "routes": {
      ...
      "home": {
        ...
        "emptyHomeBody": "تابع مجتمعًا أو انضم إليه لتبدأ في بناء خلاصتك الرئيسية.",
  ...
  "zh": {
    "routes": {
      ...
      "home": {
        ...
        "emptyHomeBody": "关注或加入一个社区，开始建立你的首页动态。",
