  ...
  "en": {
    ...
    "routes": {
      ...
      "settings": {
        ...
        "buyNamePayClaimAction": "Pay and claim",
        "buyNamePricingLabel": "{tier} pricing",
        "buyNameQuoteValid": "Quote valid for {minutes} min",
        "buyNameSubtitle": "Search platform names and pay with USDC from your primary wallet.",
        "buyNameTitle": "Buy .pirate name",
  ...
  "ar": {
    ...
    "routes": {
      ...
      "settings": {
        ...
        "buyNamePayClaimAction": "ادفع واحجز",
        "buyNamePricingLabel": "تسعير {tier}",
        "buyNameQuoteValid": "السعر صالح لمدة {minutes} دقيقة",
        "buyNameSubtitle": "ابحث عن أسماء المنصة وادفع USDC من محفظتك الأساسية.",
        "buyNameTitle": "اشتر اسم .pirate",
  ...
  "zh": {
    ...
    "routes": {
      ...
      "settings": {
        ...
        "buyNameNameLabel": "名称",
        "buyNamePayClaimAction": "支付并认领",
        "buyNamePricingLabel": "{tier} 定价",
        "buyNameQuoteValid": "报价有效期 {minutes} 分钟",
        "buyNameSubtitle": "搜索平台名称，并用主钱包中的 USDC 支付。",
        "buyNameTitle": "购买 .pirate 名称",
