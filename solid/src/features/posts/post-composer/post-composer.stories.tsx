...
export const AudiencePublic: Story = {
  name: "Audience / Public (AudiencePublic)",
  render: () => (
    <ComposerFrame>
      <PostComposer
        {...baseComposer}
        audience={{ visibility: "public", publicOptionEnabled: true }}
        composerStep="settings"
        titleValue="Legacy public audience"
      />
    </ComposerFrame>
  ),
};
export const AudiencePublicDisabled: Story = {
  name: "Audience / Members-only (AudiencePublicDisabled)",
  render: () => (
    <ComposerFrame>
      <PostComposer
        {...baseComposer}
        audience={{ visibility: "members_only", publicOptionEnabled: false, publicOptionDisabledReason: "Legacy audience compatibility state." }}
        composerStep="settings"
        titleValue="Legacy members-only audience"
      />
    </ComposerFrame>
  ),
};
export const LinkPasteUrl: Story = {
  name: "Attachment / Paste URL (LinkPasteUrl)",
  render: () => (
    <ComposerFrame>
      <PostComposer
        {...baseComposer}
        mode="link"
        titleValue="Legacy URL paste compatibility"
        linkUrlValue="https://pirate.sc/legacy-link-paste"
        textBodyValue="A compatibility URL-paste state with its own preview."
        linkPreview={{
          domain: "pirate.sc",
          title: "Legacy link paste",
          description: "Compatibility catalog state for URL paste.",
          state: "preview",
        }}
      />
    </ComposerFrame>
