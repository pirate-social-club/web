    ...
    "routes": {
      ...
      "moderation": {
        ...
        "namespaceVerification": {
          ...
          "signatureNote": "Use the signing helper with the Spaces wallet that owns this root. This only signs a one-time challenge.",
          "signingStepGetHelper": "Clone the Pirate signing helper from GitHub.",
          "signingStepRunHelper": "Run it where your Spaces wallet is available.",
          "signingStepPasteSignature": "Copy signature from the output and paste it below.",
          "signingHelperCommandLabel": "Signing helper command",
          "signingHelperRequirement": "Requires Bun, Rust, and the Spaces wallet that owns this root.",
          "digestLabel": "Digest",
