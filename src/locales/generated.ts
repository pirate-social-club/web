    ...
    "routes": {
      ...
      "post": {
        ...
        "songContent": {
          ...
          "buyDigitalMp3ForPrice": "Buy Digital MP3 for {price}",
          "unlock": "Unlock",
          "unlockDigitalMp3": "Unlock Digital MP3",
          "study": "Study",
          "studyEarnReward": "Study · Earn {reward}",
          "studyAriaLabel": "Study this song line by line",
          "studyLocked": "Study is locked. Check the song access settings.",
          "sing": "Sing",
          "singEarnReward": "Sing · Earn {reward}",
          "singAriaLabel": "Sing this song with karaoke",
          "singSetupFailed": "Sing setup failed. Check the lyrics and stems, then retry publishing.",
          "studySingSetupFailed": "Study and Sing setup failed. Check the song setup, then retry publishing.",
          "buyVinyl": "Buy vinyl on ElasticStage",
          "vinylLabel": "Vinyl",
          "pause": "Pause",
          "play": "Play",
          "loading": "Loading",
          ...
          "providerKeyMissing": "{label} needs an ElevenLabs key. Add it in Integrations.",
          "providerKeyInvalid": "The ElevenLabs key did not work. Check it in Integrations.",
          "providerRateLimited": "ElevenLabs is rate-limiting this community. Try again in a minute.",
          "providerUnavailable": "ElevenLabs was unavailable. Retry publishing in a minute.",
          "providerTimeout": "ElevenLabs timed out. Retry publishing.",
          "providerInvalidResponse": "ElevenLabs returned an unreadable response. Retry publishing.",
          "lyricsMissing": "{label} needs lyrics. Add lyrics and retry.",
          "lyricsTooShort": "{label} needs more lyrics. Add a longer lyric set.",
          "instrumentalMissing": "Sing needs an instrumental track. Upload stems and retry.",
          "timedLyricsMissing": "Timed lyrics could not be prepared. Check the lyrics and audio, then retry.",
          "exerciseGenerationFailed": "Study exercises could not be generated. Retry publishing.",
          "karaokeDisabled": "Karaoke is disabled for this community.",
          "locked": "{label} is locked until the song is purchased.",
          "remixOf": "Remix of",
          "samples": "Samples",
          "references": "References",
          "inspiredBy": "Inspired by",
          "derivedFrom": "Derived from",
          "titleByArtist": "{title} by {artist}",
          "titleRemix": "{title} remix"
        },
        "engagement": {
          "share": "Share"
        },
        "liveRoom": {
          ...
          "buy": "Buy",
          "buyForPrice": "Buy {price}",
          "watchReplay": "Watch replay",
          "verifyToAttend": "Verify to attend",
          "buySongToWatch": "Buy song to watch",
          "buySongToWatchForPrice": "Buy song to watch · {price}",
          "verifyAccess": "Verify access",
          "getTicket": "Get ticket",
          "getTicketForPrice": "Get ticket {price}",
          ...
          "producerInviteHint": "Accept the producer invite before broadcasting.",
          "producerInviteRevoked": "This producer invite has been revoked.",
          "agentCheckout": "Agent checkout"
        },
        "route": {
          "ageVerificationCompleteError": "Could not complete age verification.",
          "ageVerificationStartError": "Could not start age verification.",
          "ageVerificationRequired": "Age verification is required to view 18+ content.",
          "linkedSongAgeVerificationRequired": "Age verification is required to use Sing or Study for this linked song.",
          "signInToBoost": "Sign in to boost this song.",
          "signInToComment": "Sign in to comment.",
          "connectWalletToVerifyAge": "Connect your wallet to verify your age and view 18+ content.",
          "connectWalletToBuyTicket": "Connect your wallet to buy a ticket for this live room.",
          "connectWalletToBuyReplay": "Connect your wallet to buy this replay.",
          "connectWalletToUseKaraoke": "Connect your wallet to use karaoke.",
          "connectWalletToStudy": "Connect your wallet to study this song.",
          "connectWalletToSeeStreaks": "Connect your wallet to see this song's streak leaderboard.",
          "connectWalletToUnlockReplay": "Connect a wallet to unlock this replay.",
          "connectWalletToVerifyCommunityAccess": "Connect your wallet to verify community access for this live room.",
          "connectWalletToAcceptInvite": "Connect your wallet to accept this producer invite.",
          "assetStatusLoadFailed": "Could not load asset status.",
          "liveRoomAccessLoadFailed": "Could not load live room access.",
          "liveRoomJoinFailed": "Could not join this live room.",
          "liveRoomNotLiveYet": "This live room is not live yet.",
          "liveRoomRenewFailed": "Could not renew live room access.",
          "liveRoomUnavailable": "This live room is not available.",
          "ticketSetupIncomplete": "Ticket setup is incomplete for this live room.",
          "replayFallbackTitle": "Replay",
          "replayPurchaseSetupIncomplete": "Purchase setup is incomplete for this replay.",
          "replayDeliveryPending": "This replay is still being prepared.",
          "replayNotPublished": "This replay has not been published yet.",
          "replayUnavailable": "This replay is not available.",
          "replayWatchFailed": "Could not watch this replay.",
          "producerInviteAccepted": "Producer invite accepted.",
          "producerInviteAcceptFailed": "Could not accept this producer invite.",
          "storeFallbackLabel": "Store",
          "liveRoomFallbackTitle": "Live room",
          "publicLabel": "Public",
      ...
      "profile": {
        ...
        "bookTab": "Book",
        "bookTimesIn": "Times in {timezone}",
        "bookDayNoTimes": "No open times this day.",
        ...
        "bookSheetDescription": "Pick a time. Confirm and pay on the next step.",
  ...
  "ar": {
    ...
    "routes": {
      "common": {
        ...
        "commentsHeadingWithCount": "التعليقات {count}",
      ...
      "post": {
        ...
        "songContent": {
          ...
          "buyDigitalMp3ForPrice": "اشترِ MP3 رقمي مقابل {price}",
          "unlock": "إلغاء القفل",
          "unlockDigitalMp3": "إلغاء قفل MP3 الرقمي",
          "study": "تعلّم",
          "studyEarnReward": "تعلّم · اكسب {reward}",
          "studyAriaLabel": "تعلّم هذه الأغنية سطرًا بسطر",
          "studyLocked": "التعلّم مقفل. تحقّق من إعدادات الوصول إلى الأغنية.",
          "sing": "غنِّ",
          "singEarnReward": "غنِّ · اكسب {reward}",
          "singAriaLabel": "غنِّ هذه الأغنية مع الكاراوكي",
          "singSetupFailed": "فشل إعداد الغناء. تحقّق من الكلمات والمسارات ثم أعد النشر.",
          "studySingSetupFailed": "فشل إعداد التعلّم والغناء. تحقّق من إعداد الأغنية ثم أعد النشر.",
          "buyVinyl": "اشترِ أسطوانة فينيل على ElasticStage",
          "vinylLabel": "فينيل",
          "pause": "إيقاف مؤقت",
          "play": "تشغيل",
          "loading": "جارٍ التحميل",
          ...
          "trackPosition": "موضع المقطع",
          "verifyAge": "تحقّق من العمر",
          "providerKeyMissing": "يحتاج {label} إلى مفتاح ElevenLabs. أضِفه في التكاملات.",
          "providerKeyInvalid": "لم يعمل مفتاح ElevenLabs. تحقّق منه في التكاملات.",
          "providerRateLimited": "تقيّد ElevenLabs هذا المجتمع مؤقتًا. أعد المحاولة بعد دقيقة.",
          "providerUnavailable": "ElevenLabs غير متاح. أعد النشر بعد دقيقة.",
          "providerTimeout": "انتهت مهلة ElevenLabs. أعد النشر.",
          "providerInvalidResponse": "أعاد ElevenLabs استجابة غير قابلة للقراءة. أعد النشر.",
          "lyricsMissing": "يحتاج {label} إلى كلمات. أضف الكلمات وأعد المحاولة.",
          "lyricsTooShort": "يحتاج {label} إلى كلمات أكثر. أضف كلمات أطول.",
          "instrumentalMissing": "يحتاج الغناء إلى مسار موسيقي. حمّل المسارات وأعد المحاولة.",
          "timedLyricsMissing": "تعذر إعداد كلمات متزامنة. تحقّق من الكلمات والصوت ثم أعد المحاولة.",
          "exerciseGenerationFailed": "تعذر إنشاء تمارين التعلّم. أعد النشر.",
          "karaokeDisabled": "الكاراوكي معطل لهذا المجتمع.",
          "locked": "{label} مقفل حتى شراء الأغنية.",
          "remixOf": "ريمكس من",
          "samples": "عينات",
          "references": "مراجع",
          "inspiredBy": "مستوحى من",
          "derivedFrom": "مشتق من",
          "titleByArtist": "{title} لـ {artist}",
          "titleRemix": "ريمكس {title}"
        },
        "engagement": {
          "share": "مشاركة"
        },
        "liveRoom": {
          "canceled": "أُلغي",
          "ended": "انتهى",
          "endedAgo": "انتهى منذ {time}",
          "buy": "شراء",
          "buyForPrice": "اشترِ {price}",
          "watchReplay": "شاهد الإعادة",
          "verifyToAttend": "تحقّق للحضور",
          "buySongToWatch": "اشترِ الأغنية للمشاهدة",
          "buySongToWatchForPrice": "اشترِ الأغنية للمشاهدة · {price}",
          "verifyAccess": "تحقّق من الوصول",
          "getTicket": "احصل على تذكرة",
          "getTicketForPrice": "احصل على تذكرة {price}",
          "watchLive": "شاهد البث",
          "rsvp": "تأكيد الحضور",
          "startsAt": "يبدأ {time}",
          "host": "المضيف",
          "hostedBy": "يستضيفه",
          "with": "مع",
          "startBroadcast": "ابدأ البث",
          "openProducerRoom": "افتح غرفة المنتج",
          "acceptInvite": "اقبل الدعوة",
          "openInvite": "افتح الدعوة",
          "producerInviteHint": "اقبل دعوة المنتج قبل البث.",
          "producerInviteRevoked": "تم إلغاء دعوة المنتج هذه.",
          "agentCheckout": "إتمام الشراء عبر الوكيل"
        },
        "route": {
          "ageVerificationCompleteError": "تعذر إكمال التحقق من العمر.",
          "ageVerificationStartError": "تعذر بدء التحقق من العمر.",
          "ageVerificationRequired": "يلزم التحقق من العمر لعرض المحتوى المخصص لـ 18+.",
          "linkedSongAgeVerificationRequired": "يلزم التحقق من العمر لاستخدام الغناء أو الدراسة في هذه الأغنية المرتبطة.",
          "signInToBoost": "سجّل الدخول لتعزيز هذه الأغنية.",
          "signInToComment": "سجّل الدخول للتعليق.",
          "connectWalletToVerifyAge": "اربط محفظتك للتحقق من عمرك وعرض المحتوى المخصص لـ 18+.",
          "connectWalletToBuyTicket": "اربط محفظتك لشراء تذكرة لهذه الغرفة المباشرة.",
          "connectWalletToBuyReplay": "اربط محفظتك لشراء هذه الإعادة.",
          "connectWalletToUseKaraoke": "اربط محفظتك لاستخدام الكاراوكي.",
          "connectWalletToStudy": "اربط محفظتك لتعلّم هذه الأغنية.",
          "connectWalletToSeeStreaks": "اربط محفظتك لعرض لوحة متصدر السلاسل لهذه الأغنية.",
          "connectWalletToUnlockReplay": "اربط محفظة لإلغاء قفل هذه الإعادة.",
          "connectWalletToVerifyCommunityAccess": "اربط محفظتك للتحقق من وصول المجتمع لهذه الغرفة المباشرة.",
          "connectWalletToAcceptInvite": "اربط محفظتك لقبول دعوة المنتج هذه.",
          "assetStatusLoadFailed": "تعذر تحميل حالة الأصل.",
          "liveRoomAccessLoadFailed": "تعذر تحميل الوصول إلى الغرفة المباشرة.",
          "liveRoomJoinFailed": "تعذر الانضمام إلى هذه الغرفة المباشرة.",
          "liveRoomNotLiveYet": "هذه الغرفة المباشرة ليست مباشرة بعد.",
          "liveRoomRenewFailed": "تعذر تجديد الوصول إلى الغرفة المباشرة.",
          "liveRoomUnavailable": "هذه الغرفة المباشرة غير متاحة.",
          "ticketSetupIncomplete": "إعداد التذاكر غير مكتمل لهذه الغرفة المباشرة.",
          "replayFallbackTitle": "إعادة",
          "replayPurchaseSetupIncomplete": "إعداد الشراء غير مكتمل لهذه الإعادة.",
          "replayDeliveryPending": "هذه الإعادة لا تزال قيد الإعداد.",
          "replayNotPublished": "لم تُنشر هذه الإعادة بعد.",
          "replayUnavailable": "هذه الإعادة غير متاحة.",
          "replayWatchFailed": "تعذرت مشاهدة هذه الإعادة.",
          "producerInviteAccepted": "تم قبول دعوة المنتج.",
          "producerInviteAcceptFailed": "تعذر قبول دعوة المنتج هذه.",
          "storeFallbackLabel": "المتجر",
          "liveRoomFallbackTitle": "غرفة مباشرة",
          "publicLabel": "علني",
      ...
      "createPost": {
        ...
        "live": {
          ...
          "paidVisibilityNote": "يجب أن تكون البثوث المباشرة المدفوعة عامة. اختر «عام» للمتابعة.",
      ...
      "profile": {
        ...
        "bookTab": "التقويم",
        "bookTimesIn": "التوقيت في {timezone}",
        "bookDayNoTimes": "لا توجد أوقات متاحة في هذا اليوم.",
        "bookContinue": "متابعة",
        ...
        "bookSheetDescription": "اختر وقتًا. ستؤكد وتدفع في الخطوة التالية.",
  ...
  "zh": {
    ...
    "routes": {
      "common": {
        ...
        "close": "关闭",
        "commentsHeading": "评论",
        "commentsHeadingWithCount": "评论 {count}",
      ...
      "post": {
        ...
        "songContent": {
          ...
          "buyDigitalMp3ForPrice": "以 {price} 购买数字 MP3",
          "unlock": "解锁",
          "unlockDigitalMp3": "解锁数字 MP3",
          "study": "学习",
          "studyEarnReward": "学习 · 赚 {reward}",
          "studyAriaLabel": "逐句学习这首歌",
          "studyLocked": "学习功能已锁定。请检查歌曲访问设置。",
          "sing": "跟唱",
          "singEarnReward": "跟唱 · 赚 {reward}",
          "singAriaLabel": "使用卡拉 OK 跟唱这首歌",
          "singSetupFailed": "跟唱设置失败。请检查歌词和音轨后重新发布。",
          "studySingSetupFailed": "学习和跟唱设置失败。请检查歌曲设置后重新发布。",
          "buyVinyl": "在 ElasticStage 购买黑胶",
          "vinylLabel": "黑胶",
          "pause": "暂停",
          "play": "播放",
          "loading": "加载中",
          "playPreview": "播放预览",
          "previewSeconds": "预览（{seconds}秒）",
          "trackPosition": "曲目位置",
          "verifyAge": "验证年龄",
          "providerKeyMissing": "{label}需要 ElevenLabs 密钥。请在集成中添加。",
          "providerKeyInvalid": "ElevenLabs 密钥无效。请在集成中检查。",
          "providerRateLimited": "ElevenLabs 正在限制此社区的请求。请稍后再试。",
          "providerUnavailable": "ElevenLabs 暂时不可用。请稍后重新发布。",
          "providerTimeout": "ElevenLabs 超时。请重新发布。",
          "providerInvalidResponse": "ElevenLabs 返回了无法读取的响应。请重新发布。",
          "lyricsMissing": "{label}需要歌词。请添加歌词后重试。",
          "lyricsTooShort": "{label}需要更多歌词。请添加更长的歌词。",
          "instrumentalMissing": "跟唱需要伴奏音轨。请上传分轨后重试。",
          "timedLyricsMissing": "无法准备时间轴歌词。请检查歌词和音频后重试。",
          "exerciseGenerationFailed": "无法生成学习练习。请重新发布。",
          "karaokeDisabled": "此社区已禁用卡拉 OK。",
          "locked": "购买歌曲前，{label}已锁定。",
          "remixOf": "混音自",
          "samples": "采样",
          "references": "引用",
          "inspiredBy": "灵感来自",
          "derivedFrom": "衍生自",
          "titleByArtist": "{artist} 的《{title}》",
          "titleRemix": "《{title}》混音"
        },
        "engagement": {
          "share": "分享"
        ...
        "liveRoom": {
          "canceled": "已取消",
          "ended": "已结束",
          "endedAgo": "已于 {time} 前结束",
          "buy": "购买",
          "buyForPrice": "以 {price} 购买",
          "watchReplay": "观看回放",
          "verifyToAttend": "验证后参加",
          "buySongToWatch": "购买歌曲以观看",
          "buySongToWatchForPrice": "购买歌曲以观看 · {price}",
          "verifyAccess": "验证访问权限",
          "getTicket": "获取门票",
          "getTicketForPrice": "以 {price} 获取门票",
          "watchLive": "观看直播",
          "rsvp": "确认参加",
          "startsAt": "{time}开始",
          "host": "主持人",
          ...
          "with": "与",
          "startBroadcast": "开始直播",
          "openProducerRoom": "打开制作人房间",
          "acceptInvite": "接受邀请",
          "openInvite": "打开邀请",
          "producerInviteHint": "请先接受制作人邀请，再开始直播。",
          "producerInviteRevoked": "此制作人邀请已被撤销。",
          "agentCheckout": "代理结账"
        },
        "route": {
          "ageVerificationCompleteError": "无法完成年龄验证。",
          "ageVerificationStartError": "无法启动年龄验证。",
          "ageVerificationRequired": "查看 18+ 内容需要验证年龄。",
          "linkedSongAgeVerificationRequired": "使用此关联歌曲的跟唱或学习功能需要验证年龄。",
          "signInToBoost": "登录以推广这首歌。",
          "signInToComment": "登录以评论。",
          "connectWalletToVerifyAge": "连接钱包以验证年龄并查看 18+ 内容。",
          "connectWalletToBuyTicket": "连接钱包以购买此直播房间的门票。",
          "connectWalletToBuyReplay": "连接钱包以购买此回放。",
          "connectWalletToUseKaraoke": "连接钱包以使用卡拉 OK。",
          "connectWalletToStudy": "连接钱包以学习这首歌。",
          "connectWalletToSeeStreaks": "连接钱包以查看这首歌的连续学习排行榜。",
          "connectWalletToUnlockReplay": "连接钱包以解锁此回放。",
          "connectWalletToVerifyCommunityAccess": "连接钱包以验证此直播房间的社区访问权限。",
          "connectWalletToAcceptInvite": "连接钱包以接受此制作人邀请。",
          "assetStatusLoadFailed": "无法加载资产状态。",
          "liveRoomAccessLoadFailed": "无法加载直播房间访问权限。",
          "liveRoomJoinFailed": "无法加入此直播房间。",
          "liveRoomNotLiveYet": "此直播房间尚未开播。",
          "liveRoomRenewFailed": "无法续期直播房间访问权限。",
          "liveRoomUnavailable": "此直播房间不可用。",
          "ticketSetupIncomplete": "此直播房间的门票设置不完整。",
          "replayFallbackTitle": "回放",
          "replayPurchaseSetupIncomplete": "此回放的购买设置不完整。",
          "replayDeliveryPending": "此回放仍在准备中。",
          "replayNotPublished": "此回放尚未发布。",
          "replayUnavailable": "此回放不可用。",
          "replayWatchFailed": "无法观看此回放。",
          "producerInviteAccepted": "已接受制作人邀请。",
          "producerInviteAcceptFailed": "无法接受此制作人邀请。",
          "storeFallbackLabel": "商店",
          "liveRoomFallbackTitle": "直播房间",
          "publicLabel": "公开",
          "anonymousLabel": "匿名",
          "sortComments": "排序评论"
        }
      ...
      "createPost": {
        ...
        "live": {
          ...
          "paidVisibilityNote": "付费直播必须公开。请选择“公开”以继续。",
