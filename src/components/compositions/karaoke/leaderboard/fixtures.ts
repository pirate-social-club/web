...
const TOP_ENTRIES: KaraokeLeaderboardEntry[] = [
  entry(1, 9600, identity("maya", "maya", "maya")),
  entry(2, 9400, identity("diego", "diego", "diego")),
  entry(3, 9300, identity("lin", "lin", "lin")),
  entry(4, 8800, identity("sam", "sam", "sam")),
  entry(5, 8600, identity("aria", "aria", "aria")),
];
