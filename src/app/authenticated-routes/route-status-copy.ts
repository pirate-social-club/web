...
const ROUTE_STATUS_COPY: Record<RouteStatusCopyKey, {
  ...
  "create-community": {
    ...
    strings: {
      verifyDescription: "Verify your identity before creating a community.",
      verifyPendingDescription: "Complete the palm scan in Very.",
      verifyPendingTitle: "Finish your Very verification",
      verifyStartDescription: "You must complete unique-human verification before creating a community.",
      verifyStartTitle: "Verify with Very",
      reopenVerification: "Reopen Very",
  ...
  "home": {
    ...
    strings: {
      ...
      emptyYourCommunitiesBody: "Communities you create or join will show up here.",
