...
const ROUTE_MANIFEST: readonly RouteManifestEntry[] = [
  ...
  { kind: "booking-host-settings", domain: "authenticated", testPaths: [{ pathname: "/settings/bookings" }], serverRouteExpected: true },
  { kind: "booking-management", domain: "authenticated", testPaths: [{ pathname: "/bookings" }, { pathname: "/c/com_test/bookings" }], serverRouteExpected: true },
  { kind: "booking-session", domain: "authenticated", testPaths: [{ pathname: "/bookings/bkg_test/session" }], serverRouteExpected: true },
  { kind: "booking-public", domain: "authenticated", testPaths: [{ pathname: "/c/com_test/book/user_test" }], serverRouteExpected: true },
  { kind: "booking-checkout", domain: "authenticated", testPaths: [{ pathname: "/c/com_test/book/user_test/checkout" }], serverRouteExpected: true },
  ...
  { kind: "community-landing", domain: "dual", testPaths: [{ pathname: "/c/com_test" }], serverRouteExpected: true },
  { kind: "community-videos", domain: "dual", testPaths: [{ pathname: "/c/com_test/videos" }], serverRouteExpected: true },
  { kind: "community", domain: "dual", testPaths: [{ pathname: "/c/com_test/threads" }], serverRouteExpected: true },
  ...
  { kind: "post-karaoke-leaderboard", domain: "authenticated", testPaths: [{ pathname: "/p/pst_test/karaoke/leaderboard" }], serverRouteExpected: true },
