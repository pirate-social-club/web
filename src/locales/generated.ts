    ...
    "routes": {
      ...
      "settings": {
        ...
        "booking": {
          ...
          "cancellationCopy": "Bookers receive a full refund when cancelling at least 24 hours before the session. Cancellations within 24 hours of the session are non-refundable. If you (the host) cancel or no-show, the booker is fully refunded.",
    ...
    "routes": {
      ...
      "settings": {
        ...
        "booking": {
          ...
          "cancellationCopy": "يحصل الحاجزون على استرداد كامل عند الإلغاء قبل موعد الجلسة بـ24 ساعة على الأقل. الإلغاء خلال 24 ساعة من موعد الجلسة غير قابل للاسترداد. إذا ألغيت أنت (المضيف) أو لم تحضر، يحصل الحاجز على استرداد كامل.",
    ...
    "routes": {
      ...
      "settings": {
        ...
        "booking": {
          ...
          "cancellationCopy": "预约者在课程开始至少 24 小时前取消可获得全额退款。课程开始前 24 小时内取消不予退款。如果你（主持人）取消或未出席，预约者将获得全额退款。",
