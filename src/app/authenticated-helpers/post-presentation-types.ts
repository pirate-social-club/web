...
export type GenericAssetPresentationOptions = Pick<GenericAssetContentSpec, "listingMode" | "listingStatus" | "priceLabel" | "hasEntitlement" | "accessState" | "onBuy" | "onDownload">;
