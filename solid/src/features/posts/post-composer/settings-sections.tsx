                ...
                <label class="block space-y-2">
                  ...
                  <div class="grid grid-cols-[auto_1fr] items-center rounded-[var(--radius-lg)] border border-border-soft bg-background px-4">
                    ...
                    <Input
                      ...
                      inputmode="decimal"
                      onInput={(event) => props.onPriceChange(normalizePriceInput(event.currentTarget.value))}
                      pattern="[0-9]*[.]?[0-9]*"
                  ...
                  <label class="block space-y-2">
                    ...
                    <div class="grid grid-cols-[1fr_auto] items-center rounded-[var(--radius-lg)] border border-border-soft bg-background px-4">
                      <Input
                        ...
                        inputmode="numeric"
                        onInput={(event) => props.onPreviewStartSecondsChange?.(normalizeSecondsInput(event.currentTarget.value))}
            ...
            <Show when={props.attachment?.kind === "song" && props.onVinylReleaseUrlChange}>
              <label class="block space-y-2">
                ...
                <Input
                  ...
                  inputmode="url"
                  onInput={(event) => props.onVinylReleaseUrlChange?.(event.currentTarget.value)}
                ...
                <label class="block space-y-2">
                  ...
                  <div class="grid grid-cols-[1fr_auto] items-center rounded-[var(--radius-lg)] border border-border-soft bg-background px-4">
                    <Input
                      ...
                      max={100}
                      min={0}
                      onInput={(event) => props.onRoyaltyPercentChange(normalizeRoyaltyInput(event.currentTarget.value))}
