  ...
  return (
    <div className="space-y-3 rounded-lg border border-border-soft bg-muted/20 p-4 text-start">
      <div className="flex items-start gap-3">
        <span className="grid size-11 shrink-0 place-items-center rounded-lg bg-primary/10 text-primary">↓</span>
        <div className="min-w-0 flex-1">
          ...
          <Type as="p" variant="caption" className="text-muted-foreground">
            Locked downloadable file · signed delivery
          </Type>
        </div>
      </div>
