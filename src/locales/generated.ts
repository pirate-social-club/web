  ...
  "en": {
    "gates": {
      "requirements": {
        ...
        "gender": {
          "public": "ID check",
          "adminWithValue": "Requires Self document marker {requiredValue}"
        },
        "uniqueHuman": {
          "very": "Palm scan",
    ...
    "routes": {
      ...
      "createCommunity": {
        ...
        "composer": {
          ...
          "contentRatingSection": "Content rating",
      ...
      "moderation": {
        ...
        "gates": {
          ...
          "membershipGatedLabel": "Gated",
          "membershipGatedDetail": "Joining requires passing one or more gate checks.",
          "gateChecksDescription": "No gate checks selected yet.",
          ...
          "courtyardDescription": "Create communities based on Pokémon cards, One Piece, and luxury watches.",
          "courtyardCatalogUnavailable": "Catalog source not connected.",
          "contentRatingTitle": "Content rating",
  ...
  "ar": {
    "gates": {
      "requirements": {
        ...
        "gender": {
          "public": "تحقق بالهوية",
          "adminWithValue": "يتطلب علامة الجنس في وثيقة Self: {requiredValue}"
        },
        "uniqueHuman": {
      ...
      "capabilityLabels": {
        ...
        "minimumAge": "العمر",
        "nationality": "الجنسية",
        "gender": "علامة الجنس في وثيقة Self",
    ...
    "routes": {
      ...
      "createCommunity": {
        ...
        "composer": {
          ...
          "contentRatingSection": "تصنيف المحتوى",
      ...
      "moderation": {
        ...
        "gates": {
          ...
          "membershipGatedLabel": "مقيد",
          "membershipGatedDetail": "يتطلب الانضمام اجتياز بوابة واحدة أو أكثر.",
          "gateChecksDescription": "لم يتم اختيار أي فحوصات بوابة بعد.",
          "gateChecksTitle": "فحوصات البوابة",
          ...
          "courtyardDescription": "اشترط بطاقات أو ساعات محددة من Courtyard.",
          "courtyardCatalogUnavailable": "مصدر الفهرس غير متصل.",
          "contentRatingTitle": "تصنيف المحتوى",
  ...
  "zh": {
    "gates": {
      "requirements": {
        ...
        "gender": {
          "public": "使用身份证件验证",
          "adminWithValue": "需要 Self 证件性别标记 {requiredValue}"
        },
        "uniqueHuman": {
          "very": "需要掌纹扫描",
          "self": "需要真人验证"
    ...
    "routes": {
      ...
      "moderation": {
        ...
        "gates": {
          ...
          "membershipGatedLabel": "受限",
          "membershipGatedDetail": "加入需要通过一个或多个门槛检查。",
          "gateChecksDescription": "尚未选择任何门槛检查。",
          "gateChecksTitle": "门槛检查",
