  ...
  "en": {
    "gates": {
      ...
      "treeBuilder": {
        ...
        "tryProfileTitle": "Try a profile",
        "tryProfileCaption": "Tick what this person can prove, then see whether the rules let them in.",
        "tryProfileNoRules": "No rules yet — anyone can join.",
        "tryProfileVerdictPass": "This person CAN join",
        "tryProfileVerdictFail": "This person CANNOT join",
        "tryProfileVerdictUnknown": "Cannot determine — an unrecognized requirement is pivotal",
        "tryProfileReset": "Reset profile",
        "tryProfileRequirements": "Requirements",
        "profileHumanProvider": "Verified human via {provider}",
        "profileAltcha": "Completes the browser challenge",
        "profileAge": "Age",
        "profileNationality": "Nationality",
        "profileGender": "Document sex marker",
        "profilePassportScore": "Passport score",
        "profileHoldsAsset": "Holds {asset}",
        "profileAssetQuantity": "Quantity held for {asset}",
        "profileNone": "None",
        "profileAnyNationality": "Any verified nationality",
