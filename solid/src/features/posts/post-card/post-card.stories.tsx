...
import {
  basePostFixture,
  cityEventBylineFixture,
  communityMeetupEventFixture,
  fabrikaPlaceFixture,
  fixtureImage,
  ineligibleShareActionsFixture,
  longTextPostBodyFixture,
  noop,
  ticketedLinkEventFixture,
} from "./fixtures";
...
const meta = {
  ...
  parameters: {
    docs: {
      description: {
        component:
          "The feed post card. Every React story state is mirrored with deterministic offline fixtures: imagery is inline SVG, card navigation is the onNavigate callback, and the 12 embed variants stay consolidated in the interactive Embed / Variants story exactly as in the React source.",
      },
    },
  },
  decorators: [
...
export const SharePillCrosspostIneligible: Story = {
  ...
  render: () => (
    <PostCard
      ...
      shareActions={ineligibleShareActionsFixture}
    />
  ),
};

const georgiaByline = (timestampLabel: string): PostCardProps["byline"] => ({
  community: { kind: "community", label: "c/@🇬🇪", href: "#", avatarSrc: fixtureImage("georgia-community", 80, 80) },
  author: { kind: "user", label: "u/nino", href: "#", avatarSrc: fixtureImage("avatar-nino", 100, 100) },
  timestampLabel,
});

function CrosspostStory(props: {
  byline: PostCardProps["byline"];
  engagement: PostCardProps["engagement"];
  source: Extract<PostCardProps["content"], { type: "crosspost" }>["source"];
  title: string;
}) {
  return (
    <PostCard
      {...basePost}
      byline={props.byline}
      content={{ type: "crosspost", source: props.source }}
    ...
    <CrosspostStory
      ...
      source={{
        ...
        mediaPreview: {
          type: "song",
          accessMode: "locked",
          artworkSrc: fixtureImage("crosspost-source-song", 320, 320),
          durationMs: 214000,
...
export const CrosspostUnavailableSource: Story = {
  ...
  render: () => (
    <CrosspostStory
      byline={georgiaByline("1h")}
      engagement={{ score: 21, commentCount: 9 }}
      title="Discussion moved here"
      source={{ status: "deleted", communityLabel: "music.pirate" }}
    />
  ),
};
...
export const TranslatedImagePost: Story = {
  ...
  render: () => (
    <PostCard
      ...
      content={{
        type: "image",
        src: fixtureImage("pirate-translated-caption", 600, 400),
...
export const ToggleToOriginal: Story = {
  ...
  play: async ({ canvasElement }) => {
    ...
    const toggle = canvas.getByRole("button", { name: "Show original" });
    await userEvent.click(toggle);
    await expect(canvas.getByText("今週は何を聴いていますか？")).toBeInTheDocument();
  },
};
...
export const CommunityOwnerBadge: Story = {
  ...
  render: () => <PostCard {...basePost} authorCommunityRole="owner" viewContext="community" />,
};

export const CommunityModeratorBadge: Story = {
  name: "Public Author / Moderator Badge",
  render: () => <PostCard {...basePost} authorCommunityRole="moderator" viewContext="community" />,
};
      ...
      <PostCard
        ...
        byline={{
          ...
          author: {
            ...
            href: "#",
            avatarSrc: fixtureImage("avatar-author", 100, 100),
          },
          timestampLabel: "23h",
        }}
...
export const ImagePost: Story = {
  ...
  render: () => (
    <PostCard
      ...
      content={{
        type: "image",
        src: fixtureImage("pirate-cover", 600, 400),
        alt: "Album artwork",
  ...
  render: () => (
    <PostCard
      ...
      content={{
        ...
        previewImageSrc: fixtureImage("pirate-link", 240, 240),
      }}
...
export const TextPostWithEvent: Story = {
  ...
  render: () => (
    <PostCard
      ...
      event={communityMeetupEventFixture}
  ...
  render: () => (
    <PostCard
      ...
      content={{
        ...
        previewImageSrc: fixtureImage("tbilisi-event-link", 240, 240),
      ...
      event={ticketedLinkEventFixture}
  ...
  render: () => (
    <PostCard
      ...
      content={{
        ...
        src: fixtureImage("tbilisi-film-night", 600, 400),
      }}
  ...
  render: () => (
    <PostCard
      ...
      event={{
        ...
        locationName: fabrikaPlaceFixture.label,
        place: fabrikaPlaceFixture,
...
export const EventStatusVariants: Story = {
  ...
  render: () => (
    <div class="flex flex-col">
      <PostCard
        {...basePost}
        byline={{ ...cityEventBylineFixture, timestampLabel: "1h" }}
      ...
      <PostCard
        {...basePost}
        byline={{ ...cityEventBylineFixture, timestampLabel: "3h" }}
...
export const PastEvent: Story = {
  ...
  render: () => (
    <PostCard
      {...basePost}
      byline={{ ...cityEventBylineFixture, timestampLabel: "3w" }}
      content={{
        type: "text",
...
export const MinimalEvent: Story = {
  ...
  render: () => (
    <PostCard
      {...basePost}
      byline={{
        community: { kind: "community", label: "c/remote-workers", href: "#", avatarSrc: fixtureImage("remote-community", 80, 80) },
        author: { kind: "user", label: "u/mira", href: "#", avatarSrc: fixtureImage("avatar-mira", 100, 100) },
        timestampLabel: "44m",
      }}
...
const summaryByline: PostCardProps["byline"] = {
  author: { kind: "user", label: "alex.morgan", href: "#", avatarSrc: fixtureImage("avatar-alex", 100, 100) },
  timestampLabel: "9h",
};
...
const summaryBase = {
  ...
  previewImageSrc: fixtureImage("aid-flotilla", 320, 320),
} as const;
...
// ============================================================================
// EMBEDS (12 variants consolidated in one interactive story, as in React)
// ============================================================================
...
const embedVariants = {
  xPreview: {
    ...
    content: {
      ...
      preview: {
        ...
        hasMedia: true,
        mediaUrl: fixtureImage("pirate-x-embed", 240, 240),
  ...
  youtubePreview: {
    ...
    content: {
      ...
      preview: {
        ...
        thumbnailHeight: 360,
        thumbnailUrl: fixtureImage("youtube-thumbnail", 480, 360),
        thumbnailWidth: 480,
  ...
  polymarketOpen: {
    ...
    content: {
      ...
      preview: {
        ...
        imageUrl: fixtureImage("pirate-polymarket", 180, 180),
        lastPrice: 0.53,
        liquidity: 382000,
  ...
  polymarketEventMultiOutcome: {
    ...
    content: {
      ...
      preview: {
        ...
        imageUrl: fixtureImage("pirate-fda-market", 180, 180),
        outcomes: [
  ...
  polymarketEventResolvedOutcome: {
    ...
    content: {
      ...
      preview: {
        closeTime: "2027-01-01T00:00:00Z",
        imageUrl: fixtureImage("pirate-fda-market-resolved", 180, 180),
        outcomes: [
...
export const EmbedVariants: Story = {
  name: "Embed / Variants",
  render: () => {
    const [variantKey, setVariantKey] = createSignal<EmbedVariantKey>("xPreview");
    const variant = () => embedVariants[variantKey()];

    return (
      <div class="flex flex-col gap-3">
        <label class="flex items-center justify-between gap-3 rounded-lg border border-border bg-background px-3 py-2 text-base text-muted-foreground">
          <span>Embed variant</span>
          <select
            class="rounded-md border border-input bg-background px-2 py-1 text-foreground"
            onChange={(event) => setVariantKey(event.currentTarget.value as EmbedVariantKey)}
            value={variantKey()}
          >
            {embedVariantKeys.map((key) => (
              <option value={key}>{embedVariants[key].label}</option>
            ))}
          </select>
        </label>
        <PostCard
          ...
          title={(variant() as EmbedVariant).title}
        />
      </div>
    );
  },
