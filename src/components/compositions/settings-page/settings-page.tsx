    ...
    <Card className="overflow-hidden border-border bg-card shadow-none">
      <div className="space-y-4 px-5 py-5">
        <div className="space-y-1">
          ...
          {selectedLabel ? (
            <div className="truncate text-base text-muted-foreground">{selectedLabel}</div>
          ) : null}
        </div>
        <div
          className={cn(
          ...
          <MediaControlCard
            ...
            preview={(
              <Avatar
                ...
                size="lg"
                src={avatarPreview ?? profile.avatarSrc}
              />
            )}
      ...
      <SettingsSection title="Profile">
        <Card className="space-y-5 border-border bg-card px-5 py-5 shadow-none">
          <div className="space-y-2">
            ...
            />
            {profile.displayNameError ? (
              <FormNote tone="destructive">{profile.displayNameError}</FormNote>
            ) : null}
          </div>
          <div className="space-y-2">
