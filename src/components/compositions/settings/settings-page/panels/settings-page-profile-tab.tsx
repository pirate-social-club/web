...
import { GlobalHandleField } from "@/components/compositions/profiles/edit-profile-form/edit-profile-form";
...
function MediaControlCard({
  ...
  return (
    <Card className={cn("overflow-hidden border-border bg-card shadow-none", isMobile && "border-0 bg-transparent")}>
      <div className={cn("space-y-4 p-5", isMobile && "p-0")}>
...
export function ProfileTab({
  ...
  const hasExternalPublicHandles = profile.linkedHandles.some((handle) => handle.kind !== "pirate");
